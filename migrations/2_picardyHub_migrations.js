...
module.exports = async function (deployer, network, accounts) {
    ...
    console.log("artisteTokenFactory address:" + artisteTokenFactory.address)
    console.log("craudfundFactory address:" + craudfundFactory.address)
    console.log("nftRoyaltySaleFactory address:" + nftRoyaltySaleFactory.address)
    console.log("tokenRoyaltySaleFactory address:" + tokenRoyaltySaleFactory.address)
